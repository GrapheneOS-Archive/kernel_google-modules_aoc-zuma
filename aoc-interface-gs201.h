 ...
 *
 *   hash: 750427b304cf087e6d5459f5e9dfbd47e2181b50
 *
...
enum AOC_COMMAND {
  ...
  CMD_AUDIO_INPUT_SET_CHRE_SRC_GAIN_ID = 345, /* [0x0159] ->  struct CMD_AUDIO_INPUT_SET_CHRE_SRC_GAIN */
  CMD_AUDIO_INPUT_SET_CHRE_SRC_AEC_TIMEOUT_ID = 346, /* [0x015a] ->  struct CMD_AUDIO_INPUT_SET_CHRE_SRC_AEC_TIMEOUT */
};
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_SET_CHRE_SRC_GAIN_ID, UUID: 7bc088fb485f4d1b931a87087dc3974a
 */
struct CMD_AUDIO_INPUT_SET_CHRE_SRC_GAIN {
  struct CMD_HDR parent;
  uint8_t path;
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_SET_CHRE_SRC_AEC_TIMEOUT_ID, UUID: 65c161c811d81272c3681ffd923e09e2
 */
...
static inline int AocInterfaceCheck(const void * addr, int size) {
  static const uint8_t uuid_array[AOC_UUID_ENTRIES][AOC_UUID_SIZE] = { 
      ...
      { 0x65, 0xc1, 0x61, 0xc8, 0x11, 0xd8, 0x12, 0x72, 0xc3, 0x68, 0x1f, 0xfd, 0x92, 0x3e, 0x09, 0xe2},
      ...
      { 0x7b, 0xc0, 0x88, 0xfb, 0x48, 0x5f, 0x4d, 0x1b, 0x93, 0x1a, 0x87, 0x08, 0x7d, 0xc3, 0x97, 0x4a},
